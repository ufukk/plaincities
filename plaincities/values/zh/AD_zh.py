ids = [3040051, 3041563]
names = ["萊塞斯卡爾德－恩戈爾達", "Andorra la Vella"]
...
altitudes = [-1, -1]
parents = ["AD.08", "AD.07"]
states = {"AD.06": ["圣胡利娅-德洛里亚", "Sant Julia de Loria", 3039162], "AD.05": ["奥尔迪诺", "Ordino", 3039676], "AD.04": ["La Massana", "La Massana", 3040131], "AD.03": ["Encamp", "Encamp", 3040684], "AD.02": ["卡尼略", "Canillo", 3041203], "AD.07": ["Andorra la Vella", "Andorra la Vella", 3041566], "AD.08": ["萊塞斯卡爾德-恩戈爾達", "Escaldes-Engordany", 3338529]}
districts = {}
