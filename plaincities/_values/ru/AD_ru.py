ids = [3040051, 3041563]
names = ["Эскальдес-Энджордани", "Андорра-ла-Велья"]
...
altitudes = [-1, -1]
parents = ["AD.08", "AD.07"]
states = {"AD.06": ["Сан-Жулиа-де-Лория", "Sant Julia de Loria", 3039162], "AD.05": ["Ордино", "Ordino", 3039676], "AD.04": ["La Massana", "La Massana", 3040131], "AD.03": ["Encamp", "Encamp", 3040684], "AD.02": ["Канильо", "Canillo", 3041203], "AD.07": ["Andorra la Vella", "Andorra la Vella", 3041566], "AD.08": ["Эскальдес-Энгордань", "Escaldes-Engordany", 3338529]}
districts = {}
