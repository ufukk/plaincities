...
name_list = ["les Escaldes", "أندورا لا فيلا"]
ascii_name_list = [0, "Andorra la Vella"]
...
_states = {"AD.06": ["سانت جوليا دي لوريا", "Sant Julia de Loria", 3039162], "AD.05": ["أوردينو", "Ordino", 3039676], "AD.04": ["La Massana", "La Massana", 3040131], "AD.03": ["Encamp", "Encamp", 3040684], "AD.02": ["كانيلو", "Canillo", 3041203], "AD.07": ["Andorra la Vella", "Andorra la Vella", 3041566], "AD.08": ["إسكالديس أنجوردني", "Escaldes-Engordany", 3338529]}
_districts = {}